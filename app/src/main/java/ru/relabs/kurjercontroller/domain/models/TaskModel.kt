...
//        DateTime.parse(parcel.readString()),
//        parcel.readString().orEmpty(),
//        parcel.createTypedArrayList(TaskStorage).orEmpty(),
//        parcel.createTypedArrayList(TaskPublisher).orEmpty(),
//        parcel.createTypedArrayList(TaskItem).orEmpty().toMutableList(),
//        parcel.readParcelable(TaskFilters::class.java.classLoader) ?: TaskFilters.blank(),
//        parcel.readInt(),
//        parcel.readInt(),
//        parcel.readString().orEmpty(),
//        parcel.readByte() > 0,
...
//        parcel.writeByte(if (withPlanned) 1 else 0)
//    }
//
